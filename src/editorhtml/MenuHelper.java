...
import editorhtml.actions.*;
import editorhtml.listeners.TextEditMenuListener;
import editorhtml.listeners.UndoMenuListener;
...
public class MenuHelper {
    ...
    public static void initStyleMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(styleMenu, "Semi-bold", new StyledEditorKit.BoldAction());
        ...
        addMenuItem(styleMenu, "Superscript", new SubscriptAction());
        addMenuItem(styleMenu, "Subscript", new SuperscriptAction());
    ...
    public static void initEditMenu(View view, JMenuBar menuBar) {
        ...
        JMenuItem redoItem = addMenuItem(editMenu, "Undo", new RedoAction(view));
    ...
    public static void initFileMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(fileMenu, "Quit", view);
    }
}
